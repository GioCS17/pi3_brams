dset DIR_GFS/gfs.t_HH_z.pgrb2.0p25.f%f3.DATA.grib2
index ^gfs025gr.pgrb2.DATA.idx
undef 9.999E+20
title GFS MODEL 0.25 degree
dtype grib2
xdef 1440 linear 0.000000  0.25
ydef 721 linear -90.000000 0.25
tdef TDEF linear D_CTL 6hr
* PROFILE hPa
...
vars 165
bli        0,1,0   0,7,193 ** surface Best (4 layer) Lifted Index [K]
...
prcv       0,1,0   0,1,10,1 ** surface Convective Precipitation [kg/m^2]
albe       0,1,0   0,19,1,0 ** surface Albedo [%]
...
cine       0,1,0   0,7,7 ** surface Convective Inhibition [J/kg]
...
wtnv       0,200,0   0,6,6 ** entire atmosphere (considered as a single layer) Cloud Water [kg/m^2]
CWORKclm   0,200,0   0,6,193,0 ** entire atmosphere (considered as a single layer) Cloud Work Function [J/kg]
olis       0,1,0   0,5,192,0 ** surface Downward Long-Wave Rad. Flux [W/m^2]
DPT2m      0,103,2   0,0,6 ** 2 m above ground Dew Point Temperature [K]
ocis       0,1,0   0,4,192,0 ** surface Downward Short-Wave Rad. Flux [W/m^2]
...
zgeo       26,100  0,3,5 ** (1000 975 950 925 900.. 70 50 30 20 10) Geopotential Height [gpm]
...
lsmk       0,1,0   2,0,0 ** surface Land Cover (1=land, 0=sea) [Proportion]
lfts       0,1,0   0,7,192 ** surface Surface Lifted Index [K]
clsf       0,1,0   0,0,10,0 ** surface Latent Heat Net Flux [W/m^2]
...
evpp       0,1,0   0,1,200 ** surface Potential Evaporation Rate [W/m^2]
PLPL255_0mb 0,108,25500,0   0,3,200 ** 255-0 mb above ground Pressure of level from which parcel was lifted [Pa]
psat       0,104,0.995   0,0,2 ** 0.995 sigma level Potential Temperature [K]
...
pslc       0,1,0   0,3,0 ** surface Pressure [Pa]
...
mxwp       0,6,0   0,3,0 ** max wind Pressure [Pa]
tppp       0,7,0   0,3,0 ** tropopause Pressure [Pa]
pslm       0,101,0   0,3,1 ** mean sea level Pressure Reduced to MSL [Pa]
agpl       0,200,0   0,1,3 ** entire atmosphere (considered as a single layer) Precipitable Water [kg/m^2]
umrl       26,100  0,1,1 ** (1000 975 950 925 900.. 70 50 30 20 10) Relative Humidity [%]
ur2m       0,103,2   0,1,1 ** 2 m above ground Relative Humidity [%]
...
fzrh       0,204,0   0,1,1 ** highest tropospheric freezing level Relative Humidity [%]
RH0C       0,4,0   0,1,1 ** 0C isotherm Relative Humidity [%]
cssf       0,1,0   0,0,11,0 ** surface Sensible Heat Net Flux [W/m^2]
...
ue2m       0,103,2   0,1,0 ** 2 m above ground Specific Humidity [kg/kg]
...
cbnt       0,10,0   0,6,1,0 ** entire atmosphere Total Cloud Cover [%]
TCDCblcll  0,211,0   0,6,1,0 ** boundary layer cloud layer Total Cloud Cover [%]
lwnv       0,214,0   0,6,1,0 ** low cloud layer Total Cloud Cover [%]
mdnv       0,224,0   0,6,1,0 ** middle cloud layer Total Cloud Cover [%]
hinv       0,234,0   0,6,1,0 ** high cloud layer Total Cloud Cover [%]
TCDCccll   0,244,0   0,6,1 ** convective cloud layer Total Cloud Cover [%]
mxtp       0,103,2   0,0,4,2 ** 2 m above ground Maximum Temperature [K]
mntp       0,103,2   0,0,5,3 ** 2 m above ground Minimum Temperature [K]
...
tsfc       0,1,0   0,0,0 ** surface Temperature [K]
temp       26,100  0,0,0 ** (1000 975 950 925 900.. 70 50 30 20 10) Temperature [K]
...
tp2m       0,103,2   0,0,0 ** 2 m above ground Temperature [K]
...
uvel       26,100  0,2,2 ** (1000 975 950 925 900.. 70 50 30 20 10) U-Component of Wind [m/s]
...
mxwu       0,6,0   0,2,2 ** max wind U-Component of Wind [m/s]
...
oces       0,1,0   0,4,193,0 ** surface Upward Short-Wave Rad. Flux [W/m^2]
roce       0,8,0   0,4,193,0 ** top of atmosphere Upward Short-Wave Rad. Flux [W/m^2]
...
vvel       26,100  0,2,3 ** (1000 975 950 925 900.. 70 50 30 20 10) V-Component of Wind [m/s]
...
mxwv       0,6,0   0,2,3 ** max wind V-Component of Wind [m/s]
...
omeg       21,100  0,2,8 ** (1000 975 950 925 900.. 300 250 200 150 100) Vertical Velocity (Pressure) [Pa/s]
...
rnof       0,1,0   2,0,5,1 ** surface Water Runoff [kg/m^2]
neve       0,1,0   0,1,13 ** surface Water Equivalent of Accumulated Snow Depth [kg/m^2]
WILTsfc    0,1,0   2,0,201 ** surface Wilting Point [Fraction]
var00212m  0,103,2   0,0,21 ** 2 m above ground desc [unit]
var02224pbl 0,220,0   0,2,224 ** planetary boundary layer desc [unit]
var242sfc  0,1,0   2,4,2 ** surface desc [unit]
ENDVARS
